void parseCommand(String Command) {
  ...
  // dit gedeelte leest de data welke via SerialUSB binnenkomt,
  ...
  if (partCommand.equalsIgnoreCase("ToCal"))            //To Calbration , all motors off
  {
    Mot1On = 0;
    Mot2On = 0;
    Mot3On = 0;
    ...
    Mot7On = 0;
    Mot8On = 0;
    CalibrationIsOn = true;
  }
  else if (partCommand.equalsIgnoreCase("ToRun"))            //To Calbration , all motors off
  {
    Mot1On = 1;
    Mot2On = 1;
    Mot3On = 1;
  ...
  else if (partCommand.equalsIgnoreCase("Report"))            //Report To Serial USB
  {
    Serial.print( "mot1 ");
